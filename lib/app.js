...
module.exports = function App() {
    ...
    ], auth.retrieve, CountEndpoint('TopLevel'));

    app.get([
        '/topLevel/search/sbol',
        '/store/:store/topLevel/search/sbol'
    ], auth.retrieve, SearchSBOLEndpoint('TopLevel'));

    app.get([
        '/topLevel/search/metadata',
        '/store/:store/topLevel/search/metadata'
    ], auth.retrieve, SearchMetadataEndpoint('TopLevel'));

    app.get([
        '/topLevel/:uri/sbol',
        '/store/:store/topLevel/:uri/sbol'
    ], auth.retrieve, RetrieveSBOLEndpoint('TopLevel'));
